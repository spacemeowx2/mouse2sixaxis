...
export class HIDData {
    ...
    async restore() {
        ...
        jcDevice.onReport = (data) => {
            ...
            this.onChange(reportData.slice(0, 48))
            this.onIMUChange(parseIMUData(reportData.slice(12, 12 + 12 * 3)))
        }
    }
    async connect() {
        ...
        jcDevice.onReport = (data) => {
            ...
            this.onIMUChange?.(parseIMUData(imuRawData.slice(12, 12 + 12 * 3)))
        }
    }
}
